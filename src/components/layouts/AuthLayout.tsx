...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[45%_1fr] font-sans selection:bg-blue-100 bg-card">
      ...
      <div className="hidden lg:flex bg-[#E8F2FF] flex-col p-12 relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-lg mx-auto w-full z-20">
          ...
          <div className="relative w-full mb-10">
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl border-[8px] border-white bg-card">
              <Image
                src="/auth-image.png"
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-6 -right-4 bg-card rounded-2xl shadow-xl p-4 flex items-center gap-4 z-30 border border-slate-50 animate-in fade-in zoom-in duration-500 delay-300">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-[14px] leading-relaxed font-normal max-w-[380px]">
        ...
        {/* Footer */}
        <div className="mt-auto text-[12px] text-muted-foreground font-medium z-20">
          © 2024 LMS Portal. All rights reserved.
        </div>
      </div>

      {/* Right Pane (Dynamic Content) */}
      <div className="flex flex-col justify-center px-6 sm:px-16 md:px-24 xl:px-32 relative bg-card">
        <div className="w-full max-w-[400px] mx-auto py-12 lg:py-0">
          {children}
        </div>
        
        {/* Right Footer Links */}
        <div className="absolute bottom-10 left-0 right-0 hidden sm:flex justify-center gap-8 text-[12px] font-medium text-muted-foreground">
          <a href="#" className="hover:text-muted-foreground transition-colors">Help Center</a>
