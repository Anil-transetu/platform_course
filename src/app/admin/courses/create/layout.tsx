  ...
  const handleSave = async (status: "draft" | "published", isSilent = false) => {
    ...
    try {
      ...
      if (!courseId || String(courseId).startsWith("temp-")) {
        ...
        const payloadStr = JSON.stringify(cleanPayload(coursePayload));
        ...
        if (backendStatus === "active") {
          ...
          const activePayloadStr = JSON.stringify(cleanPayload(activeCoursePayload));
