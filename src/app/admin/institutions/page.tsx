...
} from "@/features/admin/institutions/api/use-institutions"
...
export default function InstitutionsPage() {
  ...
  const handleOpenEdit = (inst: Institution) => {
    router.push(`/admin/institutions/${inst.id}?mode=edit`)
  }

  const handleOpenDelete = (inst: Institution) => {
    router.push(`/admin/institutions/${inst.id}?mode=delete`)
  }
