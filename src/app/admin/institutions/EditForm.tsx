...
import { fetchInstitutionById, updateInstitution } from "@/features/admin/institutions/api/institution-api";
  ...
  useEffect(() => {
    const loadInstitution = async () => {
      ...
      try {
        ...
        const inst = stored.find((i: Record<string, unknown>) => i.id === id);
        if (inst) {
