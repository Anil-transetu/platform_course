  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-500">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-muted-foreground mt-1">Welcome back, Alex! Here&apos;s a summary of your academic progress this semester.</p>
      </div>
      ...
      <div className="bg-white dark:bg-card p-8 rounded-[32px] border border-gray-100 dark:border-border/50 shadow-sm">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-foreground tracking-tight">Weekly Activity</h2>
          ...
          <div className="flex items-center gap-1 p-1 bg-gray-50 dark:bg-muted/50 rounded-xl">
            <button className="px-4 py-2 text-xs font-bold text-gray-500 dark:text-muted-foreground hover:text-gray-900 dark:text-foreground transition-colors">Daily</button>
            ...
            <button className="px-4 py-2 text-xs font-bold text-gray-500 dark:text-muted-foreground hover:text-gray-900 dark:text-foreground transition-colors">Monthly</button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-card p-8 rounded-[32px] border border-gray-100 dark:border-border/50 shadow-sm flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-xl font-bold text-gray-900 dark:text-foreground">Upcoming Deadline</h3>
              <p className="text-sm text-gray-500 dark:text-muted-foreground mt-1">Design System Case Study</p>
            </div>
