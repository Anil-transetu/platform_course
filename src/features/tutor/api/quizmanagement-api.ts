...
const STATS_URL = `${API_HOST}/api/v1/tutor-portal/quizzes/stats`;
//const DASHBOARD_URL = `${API_HOST}/api/v1/tutor-portal/quizzes?search=sai&limit=10&page=1`;
const DASHBOARD_URL = `${API_HOST}/api/v1/tutor-portal/quizzes`;
...
export function useTutorQuizManagementStats() {
    return useQuery({
        queryKey: ["tutorQuizManagementStats"],
